...
#define RX_PREDICT_MULTIPLIER 2     // how many message-size to wait?
...
#ifdef IR_FREQ_38
  #define DEFAULT_TX_PERIOD (RX_DEFAULT_MSG_LEN*MS_PER_BYTE_38KHZ)
#endif

#ifdef IR_FREQ_58
  #define DEFAULT_TX_PERIOD (RX_DEFAULT_MSG_LEN*MS_PER_BYTE_58KHZ)
#endif
...
typedef struct ircomm_config {
  ...
  byte          rx_timeout_multi;  // if predicting rx length, how many messages?
